...
const TOPICS = [
  { id: 'academic', title: 'Academic Excellence', words: '45 WORDS', levels: ['A1', 'C1'], img: '/public/imgs/academic.jpg', desc: 'Master advanced vocabulary tailored for university-level research and scholarly presentations.' },
  { id: 'business', title: 'Business Communication', words: '22 WORDS', levels: ['B2'], img: '/public/imgs/business.jpg', desc: 'Master professional terminology for negotiations, meetings, and project management.' },
  { id: 'daily', title: 'Daily Conversations', words: '68 WORDS', levels: ['A2'], img: '/public/imgs/daily.jpg', desc: 'Common phrases and idioms to help you communicate naturally like a native speaker.' },
  { id: 'research', title: 'Research Methodology', words: '28 WORDS', levels: ['C1'], img: '/public/imgs/research.jpg', desc: 'Master the terminology of systematic investigation and academic inquiry.' },
  { id: 'critical', title: 'Critical Analysis', words: '25 WORDS', levels: ['B2', 'C1'], img: '/public/imgs/critical.jpg', desc: 'Essential vocabulary for evaluating complex arguments and synthesizing diverse sources.' },
  { id: 'scientific', title: 'Scientific Writing', words: '42 WORDS', levels: ['C1'], img: '/public/imgs/scientific.jpg', desc: 'Technical terminology required for drafting precise journal articles and documentation.' }
];
